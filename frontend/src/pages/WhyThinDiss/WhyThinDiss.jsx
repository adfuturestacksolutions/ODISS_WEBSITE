...
const WhyThinDiss = () => {
  ...
  return (
    <main className="why-thindiss-page">
      ...
      {/* =====================================================
          COMBINED HERO & INNOVATION SECTION
      ===================================================== */}
      <section className="thindiss-combined-hero">
        
        {/* Top Hero Part with Video Background */}
        ...
        {/* Bottom Innovation Cards Part */}
        <div className="hero-bottom-innovation">

    ...
    <main className="about-page snap-container" ref={containerRef}>
      ...
      <section className="about-hero-full-video">
        ...
        <div className="hero-content-center">
          <div className="hero-content">
            ...
            <p className="dissolve-in stagger-2 text-white" style={{ color: '#fff', fontWeight: 500 }}>
              <span style={{ display: 'inline-flex', alignItems: 'center', margin: '0 6px', verticalAlign: 'middle' }}><img src="/odiss_logo.png" alt="ODISS" style={{ height: '2.8em', width: 'auto', objectFit: 'contain', filter: 'drop-shadow(0px 0px 8px rgba(255,255,255,0.9)) brightness(0) invert(1)' }} /><sup style={{ fontSize: '0.6em', fontWeight: 800, color: '#fff', transform: 'translateY(-1.2em)' }}>®</sup></span> is shaping a smarter approach to oral dissolvable delivery through innovative dissolving strip technology — bringing together science, convenience and precision in a format designed for modern healthcare.
            </p>
          </div>
        </div>
      </section>

      {/* 2. VISION & MISSION (Premium Corporate Split Screen - Original Full Width) */}
      <section className="vm-corporate-section">

        {/* Left Panel */}
        <div className="vm-corp-left">
          <img src="/image.png" alt="Global Healthcare" className="vm-corp-globe" />
        </div>

        {/* Right Light Ivory Panel */}
        <div className="vm-corp-right">
          <div className="vm-corp-cards-container">

            {/* Vision Card */}
            <div className="vm-corp-card vision-card dissolve-in stagger-2">
              <div className="vm-corp-card-icon-col">
                <div className="vm-corp-icon-wrapper icon-vision-accent" style={{ padding: 0, overflow: 'hidden' }}>
                  <img src="/icons/icon_1.png" alt="Vision Icon" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                </div>
              </div>
              <div className="vm-corp-card-text-col">
                <h3 className="vm-corp-card-title title-vision-accent">VISION</h3>
                <div className="vm-corp-card-body">
                  <p>
                    To become a global leader in Oral Dispersible Film technology, delivering innovative solutions across Pharma, Nutra, Herbal, and Traditional Healthcare therapies for every stage of life—from children to women, men, and seniors.
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* Mission Card */}
            <div className="vm-corp-card mission-card dissolve-in stagger-3">
              <div className="vm-corp-card-icon-col">
                <div className="vm-corp-icon-wrapper icon-mission-accent" style={{ padding: 0, overflow: 'hidden' }}>
                  <img src="/icons/icon_2.png" alt="Mission Icon" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                </div>
              </div>
              <div className="vm-corp-card-text-col">
                <h3 className="vm-corp-card-title title-mission-accent">MISSION</h3>
                <div className="vm-corp-card-body">
                  <p>
                    To develop innovative, high-quality Oral Dispersible Film solutions that make healthcare delivery simpler, more convenient, precise, and accessible for everyone.
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* Center Connection Visuals (Perfectly contained by the section boundary) */}
        <div className="vm-center-visuals dissolve-in stagger-4">
          <svg
            className="vm-connectors-svg"
            width="160"
            height="400"
            viewBox="0 0 160 400"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            style={{ position: 'absolute', top: '50%', left: '0', transform: 'translate(0, -50%)', zIndex: -1, overflow: 'visible' }}
          >
            {/* Concentric circle track around the right half of the glass orb */}
            <path d="M 0 50 A 150 150 0 0 1 0 350" stroke="rgba(0,0,0,0.15)" strokeWidth="1.5" className="orbit-path-green" />

            {/* Green Dot (Vision) on the track */}
            <circle cx="115" cy="104" r="6" fill="#fff" stroke="#4a9b76" strokeWidth="3" className="orbit-dot-green" />

            {/* Blue Dot (Mission) on the track */}
            <circle cx="115" cy="296" r="6" fill="#fff" stroke="#4a7b9b" strokeWidth="3" className="orbit-dot-blue" />
          </svg>

          <div className="vm-glass-orb">
            <div className="vm-leaf-container">
              <div className="vm-leaf-green"></div>
              <div className="vm-leaf-blue"></div>
            </div>
          </div>
        </div>
      ...
      <section className="about-section text-center about-difference bg-cinematic-split">
        <div className="about-container" style={{ display: 'flex', justifyContent: 'center' }}>
          <div className="diff-sheet" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', maxWidth: '1100px' }}>
            <h2 className="dissolve-in stagger-1">Thin by <span className="text-aqua">Design</span>.<br />Smarter by <span className="text-lavender">Science</span>.</h2>
      ...
      <section className="about-section approach-section bg-soft-lavender" ref={approachSectionRef}>
        <div className="about-container text-center dissolve-in" style={{ display: 'flex', justifyContent: 'center' }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', maxWidth: '1200px', padding: '50px 30px' }}>
            ...
            <p style={{ maxWidth: '700px', margin: '0 auto 30px', fontSize: '16px', color: '#475569', lineHeight: '1.6' }}>
              Every <span style={{ display: 'inline-flex', alignItems: 'center', margin: '0 6px', verticalAlign: 'middle' }}><img src="/odiss_logo.png" alt="ODISS" style={{ height: '2.8em', width: 'auto', objectFit: 'contain', mixBlendMode: 'multiply' }} /><sup style={{ fontSize: '0.6em', fontWeight: 800, color: '#0f172a', transform: 'translateY(-1.2em)' }}>®</sup></span> solution starts with a clear need, advancing through disciplined formulation and rigorous testing to deliver smarter oral dissolving formats for real-world use.
            </p>
                  ...
                  <div className="peel-up stagger-2" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
                    <div className="node-marker gold-marker">
                      <div className="node-visual-wrapper">
                        <img src="/discover.png" alt="Discover" className="node-visual" />
                      </div>
                    </div>
                ...
                >
                  <div className="peel-up stagger-3" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
                    <div className="node-marker amber-marker">
                      <div className="node-visual-wrapper">
                        <img src="/formulate.png" alt="Formulate" className="node-visual" />
                      </div>
                    </div>
                    <div className="node-content">
                      <h4>FORMULATE</h4>
                      <p>Designing the Right Film</p>
                    </div>
                  </div>
                </div>
          ...
          >
            ...
            >
              ...
              <div className="cf-content">
                ...
                <p>Advanced polymer matrix design ensures exact API loading, uniform thickness, and fast, predictable dissolution.</p>
              </div>
            </div>
            ...
            >
              ...
              <div className="cf-content">
                <h3>Targeted Bioavailability</h3>
                <p>Engineered for efficient mucosal absorption, delivering active ingredients effectively without the need for water or swallowing.</p>
              </div>
            </div>
            ...
            >
              ...
              <div className="cf-content">
                ...
                <p>Rigorous process controls and cGMP-compliant manufacturing support high tensile strength, optimal stability, and consistent product quality.</p>
              </div>
            </div>
            ...
            >
              ...
              <div className="cf-content">
                ...
                <p>Designed for effortless oral administration, our thin, discreet films offer a simple and convenient experience for patients anytime, anywhere.</p>
              </div>
            </div>
            ...
            >
              ...
              <div className="cf-content">
                ...
                <p>Adaptable film technology supports a wide range of pharmaceutical, nutraceutical, herbal, and wellness applications across diverse patient needs.</p>
              </div>
            </div>
